"""
Created By : Daidipya
Mad Libs generator with GUI  using Python 
"""
...
def displayGetWordsScreen():
    ...
    randomButton= Button(frame, text="Totaly Random", width=10 ,command=resetText)
